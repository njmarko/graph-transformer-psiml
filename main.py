...
if (database == 'MNIST'):
    projectName = 'MNIST'
    train_loader, val_loader, test_loader, parameters = dataLoadingMNIST(image_size=28, patch_size=7, num_classes=10, channels=1, dim=64, depth=6, heads=8, mlp_dim=128, epochs=20)
    ...
    image_size, patch_size, num_classes, channels, dim, depth, heads, mlp_dim, epochs = parameters
    # default MNIST: image_size=32, patch_size=8, num_classes=100, channels=3, dim=64, depth=6, heads=8, mlp_dim=128



wandb.init(entity='njmarko', project=f'gat6')
N_EPOCHS = epochs
